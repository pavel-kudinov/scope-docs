...
Здесь описан __Creature__, у которого есть один __.body__, у которого есть множество __.cells__ и __.sticks__,
причём __Cell__ и __Stick__ образуют граф, где __Cell__ играет роль вершин, а __Stick__ играет роль рёбер графа.
При этом каждый __Cell__ может помнить список всех __.sticks__, с которыми он связан,
а __Body__ может помнить полные списки всех __.cells__ и __.sticks__, которые в него входят.
